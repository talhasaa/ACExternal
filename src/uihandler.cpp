// Copied and edited this code from the ImGui DX11 + Win32 example
...
int uiRender(std::atomic<bool> &isRunning)
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"ACExternal", nullptr };
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowExW(WS_EX_TOPMOST | WS_EX_LAYERED, wc.lpszClassName, L"ACExternal Overlay", WS_POPUP, 0, 0, monitorSize.x, monitorSize.y, nullptr, nullptr, wc.hInstance, nullptr);
